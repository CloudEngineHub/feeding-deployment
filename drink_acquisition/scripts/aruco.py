    ...
    def rgbdCallback(self, rgb_image_msg, camera_info_msg, depth_image_msg):
        ...
        if len(corners) > 0:
            ...
            for (markerCorner, markerID) in zip(corners, ids):
                ...
                cv2.putText(viz_image, str(markerID), (topLeft[0], topLeft[1] - 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
        ...
        self.center_publisher.publish(Point(center_point[0], center_point[1], center_point[2]))
