...
class AcquireBiteHLA(HighLevelAction):
    ...
    def acquire_bite(self, speed: str, autocontinue_timeout: float, ask_confirmation: bool, skewering_orientation: str) -> None:
            ...
            if skill_type == "autonomous":
                ...
                if skill == "Skewer":
                    ...
                    if skewering_orientation == "vertical":
                        skewer_angle = skewer_angle + np.pi / 2  # not actually tested...
