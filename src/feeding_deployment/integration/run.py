...
class _Runner:
    ...
    def __init__(self, scene_config: str, user: str, transfer_type: str, run_on_robot: bool, use_interface: bool, use_gui: bool, simulate_head_perception: bool, max_motion_planning_time: float,
        ...
        if resume_from_state == "":
            # clear behavior tree execution log (compute) and the NUC anomaly log
            # (append-only on the NUC side) so a fresh run inherits no prior trace.
            for _log in (self.execution_log, self.nuc_execution_log):
