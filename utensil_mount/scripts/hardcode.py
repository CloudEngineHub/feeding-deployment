...
if __name__ == "__main__":
    ...
    home_pos = [2.2912759438800285, 0.7308686750765581, 2.082994642398784, 4.109475142253324, 0.2853091081120964, 5.818345985240578, 5.988186420599291]

    inside_mount_pose = Pose(position=Point(-0.147, -0.17, 0.07), orientation=Quaternion(0.7071068, -0.7071068, 0, 0))

    outside_mount_pose = Pose(position=Point(-0.147, -0.29, 0.07), orientation=Quaternion(0.7071068, -0.7071068, 0, 0))
    outside_mount_joint_states = [2.6266411620509817, 0.6992626121546339, 2.306749708761716, 4.053362604401464, 0.9559379448584164, 5.655628973165609, 5.80065247559031]

    above_mount_pose = Pose(position=Point(-0.147, -0.17, 0.15), orientation=Quaternion(0.7071068, -0.7071068, 0, 0))
    above_mount_joint_states = [3.300153003835367, 0.39120874346320217, 1.8613410764520344, 3.862447510072517, 0.6143839397882825, 5.583536137192727, 6.276739392077158]
